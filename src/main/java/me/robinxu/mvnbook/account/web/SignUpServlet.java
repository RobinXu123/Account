package me.robinxu.mvnbook.account.web;
...
import me.robinxu.mvnbook.account.service.AccountService;
import me.robinxu.mvnbook.account.service.AccountServiceException;
import me.robinxu.mvnbook.account.service.SignUpRequest;
...
public class SignUpServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (id == null || id.length() == 0 || email == null || email.length() == 0 || name == null || name.length() == 0 || password == null
				|| password.length() == 0 || confirmPassword == null || confirmPassword.length() == 0 || captchaKey == null || captchaKey.length() == 0
